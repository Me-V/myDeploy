...
const Navbar = () => {
  ...
  return (
    <nav className='text-white flex justify-between items-center px-4 h-16'>
      <Link href="/" className='logo font-bold flex justify-center items-center gap-4'>
        <Image src="/giphy.gif" width={30} height={30} alt="Logo" />
        {/* Conditionally render the text based on session */}
        {!session && <span>Get Me A Chai</span>}
      </Link>
        ...
        {session ? (
          <>
            <button
              ...
              className="my-3 mx-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              type="button"
            >
