...
const Page = () => {
    ...
    return (
        <div className="text-white py-14 container mx-auto">
            ...
            <h1 className='text-center text-white font-bold py-20 text-3xl'>Login To Get Your Fans Support You</h1>
            ...
            <div>
                ...
                <div className="flex flex-col  items-center gap-2 min-h-screen p-10">
                    ...
                    <button
                        className="flex items-center w-64 text-white bg-black border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    ...
                    <button
                        className="flex items-center w-64 bg-black text-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" onClick={()=>{signIn("github")}}>
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
