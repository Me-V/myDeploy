  ...
  return (
    <>
      <div className="gap-6 flex flex-col items-center justify-center text-white h-[44vh]">
        ...
        <div className="font-bold text-5xl flex gap-3 justify-center items-center">Buy Me A Chai <span><img src="/giphy.gif" alt="Tea GIF" width={70} /></span></div>
        <p>The is a Funding site</p>
        <div>

          <Link href="/Login">

            <button type="button" className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Start Now</button></Link>
      ...
      <div className="text-white container mx-auto">
        ...
        <div className="flex gap-5 justify-around">
          ...
          <div className="item space-y-3">
            <img className=" round-full p-2 text-black" width={160} src="/devguy3.gif" alt="Dev Guy" />
            <div className="font-bold text-white">Fund Yourself</div>
          </div>

          <div className="item space-y-3">
            <img className=" round-full p-2 text-black" width={160} src="/ZgRn.gif" alt="Dev Guy" />
            <div className="font-bold text-white">Fund Yourself</div>
          </div>

          <div className="item space-y-3">
            <img className=" round-full p-2 text-black" width={160} src="/6iyoBbdpT.gif" alt="Dev Guy" />
            <div className="font-bold text-white">Fund Yourself</div>
          </div>
